...
> Answer: Some benefits of client-side routing is that less data is requested and not pulling on the server throughout the user's experience. The pages will render faster except at the initial loading. 
